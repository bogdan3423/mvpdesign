...
export const metadata = {
  title: 'Papetărie & Office | MVP DESIGN',
  description: 'Agende personalizate, plannere, calendare, canvas, ecusoane și alte produse de papetărie pentru birou și acasă.',
};

export default function PapetarieOfficePage() {
  const categorySlug = 'papetarie-office';
      ...
      <section className="relative text-white py-12 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-orange-100 max-w-3xl">
            Produse de papetărie premium pentru birou și acasă. 
            Agende, plannere, calendare și mult mai mult, toate personalizabile după preferințele tale.
          </p>
        </div>
      </section>

...
export const metadata = {
  title: 'Lucrări academice & profesionale | MVP DESIGN',
  description: 'Servicii complete pentru lucrări de diplomă, planșe de arhitectură și inginerie, rețetare medicale și formulare personalizate.',
};

export default function LucrariAcademiceProfesionalePage() {
  const categorySlug = 'lucrari-academice-profesionale';
      ...
      <section className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-orange-100 max-w-3xl">
            Servicii specializate pentru studenți, profesori, medici și profesioniști. 
            Calitate premium pentru lucrările tale importante.
          </p>
        </div>
      </section>

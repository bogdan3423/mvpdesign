...
export const metadata = {
  title: 'Publicitate & Expunere | MVP DESIGN',
  description: 'Bannere, roll-up-uri, standuri expoziționale, mesh-uri publicitare și steaguri pentru evenimente și promovare outdoor.',
};

export default function PublicitateExpunerePage() {
  const categorySlug = 'publicitate-expunere';
      ...
      <section className="relative text-white py-12 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-orange-100 max-w-3xl">
            Soluții complete de publicitate outdoor și indoor. 
            Bannere mari, roll-up-uri profesionale, standuri expoziționale și sisteme de afișaj pentru maximum impact vizual.
          </p>
        </div>
      </section>

...
export const metadata = {
  ...
  description: 'Invitații de nuntă și botez, felicitări, albume foto, tablouri și cadouri personalizate pentru toate evenimentele tale speciale.',
};

export default function EvenimenteCadouriPersonalizatePage() {
  const categorySlug = 'evenimente-cadouri-personalizate';
      ...
      <section className="relative text-white py-12 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-orange-100 max-w-3xl">
            Fă evenimentele tale memorabile cu produsele noastre personalizate. 
            Invitații elegante, albume foto premium, tablouri și cadouri unice pentru orice ocazie specială.
          </p>
        </div>
      </section>

...
export const metadata = {
  title: 'Printuri clasice / Xerox | MVP DESIGN',
  description: 'Descoperiți gama noastră completă de printuri clasice și servicii xerox. Calitate superioară și prețuri competitive.',
};

export default function PrinturiClasiceXeroxPage() {
  const categorySlug = 'printuri-clasice-xerox';
      ...
      <section className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-orange-100 max-w-3xl">
            Servicii complete de printare și xerox pentru toate nevoile dumneavoastră. 
            De la documente simple până la materiale promoționale de impact.
          </p>
        </div>
      </section>
